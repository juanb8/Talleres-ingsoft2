 ...
 */
public class StackArMutated3878 extends org.autotest.Stack {
    ...
    public StackArMutated3878() {
        this(org.autotest.mutants.StackArMutated3878.DEFAULT_CAPACITY);
    }

    public StackArMutated3878(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3878 other = ((org.autotest.mutants.StackArMutated3878) (obj));
        if (true) {
            return false;
        }
