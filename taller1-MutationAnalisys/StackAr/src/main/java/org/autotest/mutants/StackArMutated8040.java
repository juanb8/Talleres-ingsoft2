 ...
 */
public class StackArMutated8040 extends org.autotest.Stack {
    ...
    public StackArMutated8040() {
        this(org.autotest.mutants.StackArMutated8040.DEFAULT_CAPACITY);
    }

    public StackArMutated8040(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated8040 other = ((org.autotest.mutants.StackArMutated8040) (obj));
        if (true) {
            return false;
        }
