 ...
 */
public class StackArMutated217 extends org.autotest.Stack {
    ...
    public StackArMutated217() {
        this(org.autotest.mutants.StackArMutated217.DEFAULT_CAPACITY);
    }

    public StackArMutated217(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated217 other = ((org.autotest.mutants.StackArMutated217) (obj));
        if (true) {
            return false;
        }
