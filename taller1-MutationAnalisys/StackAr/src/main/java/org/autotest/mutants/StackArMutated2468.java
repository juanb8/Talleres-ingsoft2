 ...
 */
public class StackArMutated2468 extends org.autotest.Stack {
    ...
    public StackArMutated2468() {
        this(org.autotest.mutants.StackArMutated2468.DEFAULT_CAPACITY);
    }

    public StackArMutated2468(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated2468 other = ((org.autotest.mutants.StackArMutated2468) (obj));
        if (true) {
            return false;
        }
